...
export const INITIAL_RESOURCES: ResourceItem[] = [
  ...
  // Class Tests
  {
    ...
    type: 'ct',
    ctNumber: 1,
    title: 'CT-1 Questions & Solutions: Propositional Logic & Truth Tables',
    description: 'Class Test 1 question paper with detailed derivation and logical equivalence steps.',
    storageType: 'r2',
    fileUrl: 'https://raw.githubusercontent.com/mozilla/pdf.js/ba2edeae/web/compressed.tracemonkey-pldi-09.pdf',
    hasSolution: true,
    fileSize: '1.2 MB',
  ...
  },
  {
    ...
    type: 'ct',
    ctNumber: 2,
    title: 'CT-2 Questions & Solutions: Sets, Relations & Induction',
    description: 'Class Test 2 question paper with induction proofs and relation matrices.',
    storageType: 'drive',
    fileUrl: 'https://drive.google.com/file/d/1BxiMVs0XRA5nFMdKvBdBZjgmUUqptlbs74OgvE2upms/view',
    hasSolution: true,
    fileSize: '1.4 MB',
